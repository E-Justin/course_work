...
CREATE TABLE orders (
    id SERIAL,
    date DATE NULL,
    customer_id INT NOT NULL, -- to be used as foreign key (will add fk later)
    employee_id INT NULL, -- to be used as foreign key (will add fk later)
    PRIMARY KEY (id)
);

-- bridge table to implement the 'many to many' relationship
CREATE TABLE orders_products (
    product_id INT NOT NULL,
    order_id INT NOT NULL,
    quantity INT NOT NULL,
    discount NUMERIC NOT NULL,
    PRIMARY KEY(product_id, order_id) -- two primary keys
);
...
CREATE TABLE offices (
    ...
    PRIMARY KEY (id),
    territory_id INT NOT NULL -- to be used as foreign key.. will add fk later
);
...
----------------------------------
-- one to many relationship btwn suppliers and products --
ALTER TABLE products
ADD CONSTRAINT fk_products_suppliers
FOREIGN KEY (supplier_id)
REFERENCES suppliers (id);
-----------------------------------------------------------
------- many to many relationship btwn orders and products -------------------------
...
---------------------------------------------------------------------
--- one to one relationship btwn offices and territories ------------
ALTER TABLE offices
